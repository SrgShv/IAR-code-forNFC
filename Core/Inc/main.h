...
/* Private defines -----------------------------------------------------------*/
#define EnableTx485_Pin GPIO_PIN_2
#define EnableTx485_GPIO_Port GPIOC
...
#define EnableWP_Pin GPIO_PIN_4
#define EnableWP_GPIO_Port GPIOB

void onSetChipSel(bool flg);
bool isIRQ(void);
void onSetRELAY(bool flg);
void onSetLedRED(bool flg);
void onSetLedGREEN(bool flg);

void Error_Handler(void);
void tickTimer(void);
void PN532_Init(void);
//void PN532_ReadCard(void);
void PN532_Send(uint8_t *data, uint16_t length);
void PN532_Receive(uint8_t *buffer, uint16_t length);
//bool PN532_ReadCardUID(uint8_t* uid, uint8_t* uidLength);
bool parseRxUID(uint8_t *data, uint8_t len);
...
bool ParseModbusRX(uint8_t *data, uint16_t len);
...
//void write_then_read(uint8_t *buffTX, uint8_t nTX, uint8_t *buffRX, uint8_t nRX);
...
void onEnablePinTxRS485(bool flg);
